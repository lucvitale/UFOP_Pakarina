...
- [Repository Setup](#repository-setup)
  ...
  - [4. Navigate into the project folder](#4-navigate-into-the-project-folder)
...
- [Environment Variables](#environment-variables)
  ...
  - [Install SSH Dependency](#install-ssh-dependency)
...
- [News Module](#news-module)
  ...
  - [Interactive Suggestions](#interactive-suggestions)
  - [Dynamic Content](#dynamic-content)
- [University Server Environment](#university-server-environment)
  - [Overview](#overview)
  - [Server Information](#server-information)
  - [Required Software](#required-software-1)
  - [SSH Connection Setup (PuTTY)](#ssh-connection-setup-putty)
    - [Step 1 — Open PuTTY](#step-1--open-putty)
    - [Step 2 — Configure Session](#step-2--configure-session)
    - [Step 3 — Configure Authentication](#step-3--configure-authentication)
    - [Step 4 — Configure Username](#step-4--configure-username)
    - [Step 5 — Save Session](#step-5--save-session)
    - [Step 6 — Connect](#step-6--connect)
  - [Successful SSH Connection Example](#successful-ssh-connection-example)
  - [WinSCP Configuration](#winscp-configuration)
    - [Step 1 — Open WinSCP](#step-1--open-winscp)
    - [Step 2 — Configure Connection](#step-2--configure-connection)
    - [Step 3 — Configure SSH Key](#step-3--configure-ssh-key)
    - [Step 4 — Save Session](#step-4--save-session)
    - [Step 5 — Login](#step-5--login)
  - [File Transfer Validation](#file-transfer-validation)
  - [WinSCP File Transfer Test](#winscp-file-transfer-test)
    - [Create a Local Test File](#create-a-local-test-file)
    - [Upload the File with WinSCP](#upload-the-file-with-winscp)
    - [Verify File Transfer](#verify-file-transfer)
    - [Execute the Uploaded File](#execute-the-uploaded-file)
  ...
  - [Node.js Environment](#nodejs-environment)
    ...
    - [Install Node.js (if necessary)](#install-nodejs-if-necessary)
  ...
  - [Current Server Capabilities](#current-server-capabilities)
- [Development Workflow](#development-workflow)
- [Documentation](#documentation)
- [Error Logging and Handling](#error-logging-and-handling)
