...
- [Repository Setup](#repository-setup)
  - [Open VS Code](#1-open-vs-code)
  - [Open Terminal](#2-open-terminal)
  - [Clone the repository](#3-clone-the-repository)
  - [Navigate into the project folder](#4-navigate-into-the-project-folder)
  - [Open the project in VS Code](#5-open-the-project-in-vs-code)
